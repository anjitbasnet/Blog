...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        //For Admin User Authorization
        Gate::define('posts.addAdminUser','App\Policies\PostPolicy@addAdminUser');
        Gate::define('posts.updateAdminUser','App\Policies\PostPolicy@updateAdminUser');
        Gate::define('posts.deleteAdminUser','App\Policies\PostPolicy@deleteAdminUser');
